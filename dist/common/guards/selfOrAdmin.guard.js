...
exports.SelfOrModeratorGuard = void 0;
const common_1 = require("@nestjs/common");
const jwt_1 = require("@nestjs/jwt");
const admin_service_1 = require("../../admin/admin.service");
const customer_service_1 = require("../../customer/customer.service");
const seller_service_1 = require("../../seller/seller.service");
let SelfOrModeratorGuard = class SelfOrModeratorGuard {
    jwtService;
    adminService;
    customerService;
    sellerService;
    ...
    async canActivate(context) {
        ...
        try {
            ...
            if (resource.id !== userId && role !== "admin" && role !== "creator") {
                throw new common_1.UnauthorizedException("Siz ushbu resursning egasi yoki moderator emassiz!");
            }
            return true;
        }
        catch (err) {
            console.error("SelfOrModeratorGuard HATO:", err.message);
            response.redirect("/auth/login");
            return false;
        }
    }
...
exports.SelfOrModeratorGuard = SelfOrModeratorGuard;
exports.SelfOrModeratorGuard = SelfOrModeratorGuard = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [jwt_1.JwtService,
        admin_service_1.AdminService,
        customer_service_1.CustomerService,
        seller_service_1.SellerService])
], SelfOrModeratorGuard);
//# sourceMappingURL=SelfOrAdmin.guard.js.map