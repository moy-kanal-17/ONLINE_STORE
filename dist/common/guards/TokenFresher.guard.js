    ...
    async canActivate(context) {
        ...
        try {
            ...
            if (Date.now() - issuedAt > maxAge) {
                throw new common_1.UnauthorizedException("Token eskirgan, qayta kiring!");
            }
            return true;
        }
        catch (err) {
...
exports.TokenFreshnessGuard = TokenFreshnessGuard;
exports.TokenFreshnessGuard = TokenFreshnessGuard = __decorate([
...
//# sourceMappingURL=TokenFresher.guard.js.map